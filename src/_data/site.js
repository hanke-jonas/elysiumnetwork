...
const fallback = {
  ...
  values_short: [
    ['Freedom & equality', 'Equal access to education, opportunities and participation.', 'Every person in our network has the same right to learn, take part and be heard — regardless of nationality, gender, identity, background or belief. We don’t tolerate discrimination of any kind, and equal access to our educational and mobility opportunities is a starting point, not an aspiration. That includes who gets to lead: women, girls and gender-diverse participants have the same access to trainer, facilitator and project-lead roles as anyone else in our projects.'],
  ...
  branches: [
    {
      ...
      people: [
        { name: 'Anton Rubanenko', role: 'Head of the NGO · Project Manager', email: 'rubanenko@elysium.ngo',
          bio: "Head of the NGO and strategic manager with experience across more than 20 EU youth projects. Holds a Bachelor's degree in Business Administration, with a focus on project coordination, organisational planning and supporting young people facing social or mobility barriers." },
        { name: 'Jonas Hanke', role: 'Communication Manager · IT Support', email: 'hanke@elysium.ngo',
          bio: 'Co-founder and communication manager with a technical background in IT — system support, digital tools and the platforms that keep the network’s communication running. Has taken part in more than 10 international youth projects, with a particular interest in diversity, inclusion and equal participation.' },
      ],
    ...
    },
    {
      ...
      about: 'Elysium+ Polska is a youth-focused, non-profit initiative committed to human rights, democratic values and social inclusion. Its work is grounded in dignity, equality, solidarity and respect for diversity, and it uses youth engagement and non-formal learning to empower young people — especially those with fewer opportunities — to build awareness, responsibility and active citizenship. As part of the wider Elysium+ network, it draws on shared expertise and good practices while working with multicultural groups on human rights education, civic participation and intercultural dialogue in its own local context.',
      ...
      people: [
        { name: 'Aleksandra Sulejewska', role: 'Group Coordinator · Communication', email: 'sulejewska.pl@elysium.ngo',
          bio: "Master's student in International Relations at the University of Warsaw, specialising in international cooperation, European affairs and human rights. Has taken part in more than 10 international mobility activities, including academic experience in Rome and Warsaw." },
        { name: 'Błażej Wypart', role: 'Youth Worker · Project Manager', email: 'contact.pl@elysium.ngo',
          bio: "Bachelor's student of Cultural and Media Studies and Italian Philology, with experience across more than 15 international youth projects on human rights, democratic participation, social inclusion and non-formal education." },
      ],
    ...
    },
    {
      ...
      people: [
        { name: 'Andrea Dal Molin', role: 'Group Coordinator', email: 'dalmolin.it@elysium.ngo',
          bio: 'Political Science student at LUISS University in Rome, with academic interests in international politics, European affairs and political philosophy. Contributes to the Limes Club journal and has taken part in educational experiences in Spain and the United Kingdom.' },
        { name: 'Anton Rubanenko', role: 'Network Coordinator', email: 'rubanenko@elysium.ngo',
          bio: "Network coordinator with experience across more than 20 EU-funded youth projects. Holds a Bachelor's degree in Business Administration, with a focus on project coordination, administrative and financial management, and supporting young people facing social, economic or mobility-related barriers." },
      ],
    ...
    },
    {
      ...
      status: 'In formation', accent: '#8ACE00',
      tagline: 'The German branch, in the making.',
      about: 'Astra is the German branch of the network, being established as a gemeinnützige Unternehmergesellschaft (gUG) with its registered seat in Aachen and operations in Leipzig. Registration in the Handelsregister is in progress, so the entity currently carries the "i.Gr." (in formation) suffix. Day to day, the group operates as Beyond Borders — a youth-led initiative formed by young people with varied migration backgrounds who want to create inclusive spaces for intercultural dialogue and cooperation. Its work centres on intercultural learning, social inclusion and global citizenship education: non-formal workshops on human rights, civic engagement and environmental responsibility, support for young people taking part in exchanges and training, and locally-led initiatives and online channels that reach young people with fewer opportunities.',
      focus: ['Erasmus+ project management', 'Youth exchanges & training', 'DiscoverEU', 'Intercultural learning & global citizenship', 'Leipzig & eastern Germany focus'],
      people: [
        { name: 'Jonas Hanke', role: 'Founder · Managing Director', email: 'hanke@elysium.ngo',
          bio: 'Founder and managing director, and a history student with a passion for geography. Has taken part in more than 10 Erasmus+ youth exchanges and training courses across Europe, with experience in inclusive facilitation for mixed-ability groups and intercultural communication.' },
        { name: 'Anton Rubanenko', role: 'Co-founder', email: 'rubanenko@elysium.ngo',
          bio: 'Co-founder of Beyond Borders and founder of Elysium+ Ukraine, with experience across more than 20 Erasmus+ and European Solidarity Corps activities. Brings a strong foundation in organisational management, project planning and administrative coordination.' },
      ],
