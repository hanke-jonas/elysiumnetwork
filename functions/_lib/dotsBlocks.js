...
// The three things the rest of the site can't function without. Returns
// an error string naming what's missing, or null if all present --
// checked AFTER sanitizeBlocks + deriveCoreFields, since a block can
// exist but still have an empty text/url after trimming/truncation.
